...
public abstract class ProviderCredentials {
    ...
    protected static final int CREDENTIALS_STORAGE_VERSION = 1;
    protected static final String V2_KEYS_DELIMITER = "SNDAKEYS";
...
//        bufferedOS.write((getTypeName() + "\n").getBytes(Constants.DEFAULT_ENCODING));
     ...
     *
     */
    public static ProviderCredentials load(String password, File file) {
    ...
    public static ProviderCredentials load(String password, BufferedInputStream inputStream) {
        ...
        try {
            ...
            // Use SNDA credentials classes as default non-abstract implementation
            if (partialReadOnly) {
                return new SNDACredentials(null, null, friendlyName);
            }
...
//            String[] parts = keys.split((3 <= versionNum)? V3_KEYS_DELIMITER : V2_KEYS_DELIMITER);
            String[] parts = keys.split(V3_KEYS_DELIMITER);
            int expectedParts = 2;
            ...
            return new SNDACredentials(parts[0], parts[1], friendlyName);
